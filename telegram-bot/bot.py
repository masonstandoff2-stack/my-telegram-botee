...
city_input_map = {
    ...
    "арзамас": "Арзамас",
    "краснодар": "Краснодар",  # Исправлено: было "краснодаар"
    ...
    "arzamas": "Арзамас",
    "krasnodar": "Краснодар",  # Исправлено: было "krasnodaar"
...
city_display = {
    ...
    "Новосибирск": "🍃 ɴᴏᴠᴏsɪʙ ",
    "Арзамас": "🪿 ᴀʀᴢᴀᴍᴀs ",
    "Краснодар": "🪻 ᴋʀᴀsɴᴏᴅᴀʀ ",  # Исправлено: было "Краснодаар"
    "Екатеринбург": "📗 ᴇᴋʙ ",
    "Анапа": "🪺 ᴀɴᴀᴘᴀ ",
    "Ростов": "🍺 ʀᴏsᴛᴏᴠ ",
    "Самара": "🎧 sᴀᴍᴀʀᴀ ",
...
def update_list_text():
    """Убрал заголовок 'ᴧоᴦоʙо ʙоᴩᴋᴇᴩоʙ'"""
    # Убрана строка с заголовком
    ...
    list_text = "\n".join(list_items)  # Теперь только список городов
    return list_text
...
def show_stats(message):
    ...
    if not stats:
        bot.reply_to(message, "📊 Статистика пуста. Еще никто не чекил слёты.")
        return
...
def show_my_stats(message):
    ...
    if username in stats:
        ...
        bot.reply_to(message, "📊 Вы еще не чекили слёты!")
